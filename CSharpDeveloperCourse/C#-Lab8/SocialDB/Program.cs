namespace Social
{
    ...
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            var socialDataSource = new SocialDataSource(Settings.Default.ConnectionString);

            socialDataSource.ReadAllusers();
            socialDataSource.ReadAllFriends();
            socialDataSource.ReadAllMessage();
            socialDataSource.ReadAllLikes();
                ...
                switch (i)
                {
                    case 1:
                        ...
                        foreach (var friend in userContext.Friends)
                        {
                            ...
                            Console.WriteLine("{0,-15} | {1,10}", friend.UserName, status);
                        }
